        ...
        <div class="container homepage-register-container col-md-4" id="register">
            <form action="" method="POST" class="form py-4">
                <div>
                    ...
                    <input type="text" class="form-control mb-3" name="phone" id="phone" placeholder="Phone number" pattern="[0-9]{10}" title="Please enter 10 digits for the phone number" required>
